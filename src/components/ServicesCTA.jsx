    ...
    <section className="w-full py-24">
      <div className="w-full px-5">
        <div className="max-w-2xl mx-auto text-center">
          {/* Title */}
          <h2 className="text-4xl lg:text-5xl font-Goutam text-white mb-2">
            Let's Build
          </h2>
          <h2 className="text-4xl lg:text-5xl font-Goutam text-white/50 mb-6">
            Something Great Together
          </h2>

          {/* Description */}
          <p className="text-sm text-white leading-relaxed mb-8">
            Speak with our experts to explore our
            <br />
            IT services and find the right solution for your business needs.
          </p>
